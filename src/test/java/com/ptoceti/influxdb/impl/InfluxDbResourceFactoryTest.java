...
import com.ptoceti.influxdb.RetentionPolicySerie;
...
public class InfluxDbResourceFactoryTest {
	...
	try {
	    ...
	    Assert.fail("Error creating retention policy 2:" + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error getting list of retention policies: " + ex.getMessage() + " for query: " + query.toQL());
	} 
	...
	try {
	    ...
	    Assert.fail("Error creating test user1: " + ex.getMessage() + " for query: " + query.toQL());
	} 
	...
	try {
	    ...
	    Assert.fail("Error adding privileges to test user1: " + ex.getMessage() + " for query: " + query.toQL());
	} 
	...
	try {
	    ...
	    Assert.fail("Error creating admin user: " + ex.getMessage() + " for query: " + query.toQL());
	} 
	...
	try {
	    ...
	    Assert.fail("Error getting list of users: " + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error creating continuous query: " + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error droping privileges from test user1: " + ex.getMessage() + " for query: " + query.toQL());
	} 
	...
	try {
	    ...
	    Assert.fail("Error deleting test user1: " + ex.getMessage() + " for query: " + query.toQL());
	} 
	...
	try {
	    ...
	    Assert.fail("Error deleting admin user: " + ex.getMessage() + " for query: " + query.toQL());
	} 
	...
	try {
	    ...
	    Assert.fail("Error droping retention policy 3: " + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error Accessing resource: " + ex.getMessage());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error injecting batch points: " + ex.getMessage());
	}
	...
	try {
	    ...
	    Assert.fail("Error getting measurements: " + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error getting series:  " + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error getting tag keys: " + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error getting field keys: " + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error getting tag values: " + ex.getMessage() + " for query: " + query.toQL());
	} 
    }
	...
	try {
	    ...
	    Assert.fail("Error injecting  points: " + ex.getMessage());
	} 
	...
	try {
	    ...
	    Assert.fail("Error injecting  batch: " + ex.getMessage());
	} 
	...
	try {
	    ...
	    Assert.fail("Error Accessing resource: " + ex.getMessage() + " for query: " + query.toQL());
	} 
